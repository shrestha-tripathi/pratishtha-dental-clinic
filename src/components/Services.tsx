        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {clinic.services.map((s, i) => (
            <FadeUp
              key={s.title}
              delay={(i % 3) * 0.07}
              className="group relative p-6 rounded-2xl bg-white border border-teal-700/5 hover:border-teal-700/20 hover:shadow-xl hover:-translate-y-1 transition-[box-shadow,border-color,transform] duration-300"
            >
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-mint-50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />
