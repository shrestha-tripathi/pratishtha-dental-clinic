...
export const clinic = {
  ...
  services: [
    { icon: "tooth-spark", title: "Root Canal Treatment", desc: "Pain-free, single-sitting RCTs using modern rotary endodontics — Dr. Pratishtha's specialty." },
    { icon: "tooth-smile", title: "Cosmetic Dentistry", desc: "Smile makeovers, veneers, and tooth-colored restorations that look completely natural." },
    { icon: "tooth-implant", title: "Dental Implants", desc: "Permanent tooth replacements that look, feel, and function like the real thing." },
    { icon: "tooth-shine", title: "Teeth Whitening", desc: "Safe, effective in-office and take-home whitening for a brighter, confident smile." },
    { icon: "tooth-baby", title: "Pediatric Dentistry", desc: "Gentle, anxiety-free dental care designed especially for our youngest patients." },
    { icon: "tooth-crown", title: "Crowns & Bridges", desc: "Premium ceramic and zirconia crowns crafted for strength, durability, and aesthetics." },
    { icon: "tooth-braces", title: "Orthodontics & Aligners", desc: "Traditional braces and clear aligners to straighten teeth at any age." },
    { icon: "tooth-clean", title: "Scaling & Polishing", desc: "Professional cleaning to keep gums healthy and prevent dental disease." },
    { icon: "tooth-shield", title: "Emergency Dental Care", desc: "Rapid relief for dental pain, broken teeth, and urgent treatment needs." },
  ],
  trustPillars: [
